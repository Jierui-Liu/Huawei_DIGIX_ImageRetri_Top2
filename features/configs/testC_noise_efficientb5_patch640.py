...
LastEditTime: 2020-11-02 01:06:56
'''
...
config = dict(
    ...
    #                           
    train_pipeline = dict(
        dataloader = dict(batch_size = 9,num_workers = 16,drop_last = True,pin_memory=True,
                        collate_fn="my_collate_fn"),

        dataset = dict(type="train_dataset",
                    root_dir = r"/home/LiuJierui/Dataset/HW_Retrieval/train_data_resize640/",
    ...
    gallery_pipeline = dict(
        dataloader = dict(batch_size = 48,shuffle = False,num_workers = 16,drop_last = False,pin_memory=False,),
    ...
    model = dict(
        ...
        heads = dict(type="BNneckHead",in_feat=2048,num_classes=3097),
        losses = [
                # dict(type="AMLinear",in_features=1664,num_clssses=3097,m=0.35,s=30,weight=1/4),
                dict(type="ArcfaceLoss_Dropout",in_feat=2048,num_classes=3097,scale=35,margin=0.30,dropout_rate=0.20,weight=1),
    ...
    warm_up = dict(length=2000,min_lr=1e-6,max_lr=1e-4,froze_num_lyers=25)
