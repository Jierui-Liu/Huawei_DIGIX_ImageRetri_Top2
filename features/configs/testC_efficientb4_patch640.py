...
LastEditTime: 2020-11-18 16:09:08
'''
...
config = dict(
    ...
    train_pipeline = dict(
        ...
        dataset = dict(type="load_npy_per_instance",
                    image_dir = r"/home/LinHonghui/Datasets/HW_ImageRetrieval/train_data_resize640",
                    images_per_instance=5),
    ...
    gallery_pipeline = dict(
        ...
        dataset = dict(type="load_npy",
                    image_dir = r"/home/LinHonghui/Datasets/testC/testdata_1019_resize704/gallery",),
        transforms = [
    ...
    query_pipeline = dict(
        dataloader = dict(batch_size = 180,shuffle = False,num_workers = 16,drop_last = False),
        dataset = dict(type="load_npy",
                    image_dir = r"/home/LinHonghui/Datasets/testC/testdata_1019_resize704/query",),
        transforms = [
            dict(type="RescalePad",output_size=704),
            dict(type="ToTensor",),
            dict(type="Normalize",mean=[0.485, 0.456, 0.406],std=[0.229, 0.224, 0.225],inplace=False),
