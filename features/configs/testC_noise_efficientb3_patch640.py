...
LastEditTime: 2020-11-04 22:57:22
'''
...
config = dict(
    ...
    train_pipeline = dict(
        ...
        dataset = dict(type="train_dataset",
                    root_dir = r"/home/LinHonghui/Datasets/HW_ImageRetrieval/train_data_resize640",
    ...
    gallery_pipeline = dict(
        dataloader = dict(batch_size = 128,shuffle = False,num_workers = 16,drop_last = False,pin_memory=True,),
    ...
    model = dict(
        net = dict(type="SBNet"),
        backbone = dict(type="efficient_b3"),
        aggregation = dict(type="GeneralizedMeanPoolingP",output_size=(1,1),),
        heads = dict(type="BNneckHead",in_feat=1536,num_classes=3097),
        losses = [
                # dict(type="AMLinear",in_features=1664,num_clssses=3097,m=0.35,s=30,weight=1/4),
                dict(type="ArcfaceLoss_Dropout",in_feat=1536,num_classes=3097,scale=35,margin=0.30,dropout_rate=0.2,weight=1),
