...
LastEditTime: 2020-09-25 18:25:55
'''
...
config = dict(
    ...
    #                           
    train_pipeline = dict(
        dataloader = dict(batch_size = 7,num_workers = 12,drop_last = True,pin_memory=False,
    ...
    warm_up = dict(length=2000,min_lr=4e-6,max_lr=4e-4,froze_num_lyers=6)
    # Outpu
    # save_dir = r""
