...
LastEditTime: 2020-09-29 12:49:41
'''
...
config = dict(
    ...
    log_dir = r"../log/",
    # mode = "Finetuning", # `Finetuning` or `Normal`
    ...
    #                           
    train_pipeline = dict(
        dataloader = dict(batch_size = 5,num_workers = 12,drop_last = True,pin_memory=False,
                        collate_fn="my_collate_fn"),

        dataset = dict(type="train_dataset",
                    root_dir = r"/home/LinHonghui/Datasets/HW_ImageRetrieval/train_data_resize576",
    ...
    gallery_pipeline = dict(
        dataloader = dict(batch_size = 160,shuffle = False,num_workers = 16,drop_last = False,pin_memory=True,),
    ...
    model = dict(
        net = dict(type="SBNet_RGA"),
        backbone = dict(type="densenet169",pretrained=True,patch=576),
    ...
    warm_up = dict(length=2000,min_lr=2e-6,max_lr=2e-4,froze_num_lyers=8)
    # Outpu
    # save_dir = r""
