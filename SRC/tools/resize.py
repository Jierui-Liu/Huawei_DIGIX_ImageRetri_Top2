...
@Description : 
LastEditTime: 2020-10-25 23:38:30
'''
import os
import cv2
...
# root='/home/LinHonghui/Datasets/testC'
root="/home/LiuJierui/Dataset/HW_Retrieval"

# dir_names=['test_data_A','train_data']
# dir_names=['train_data','testdata_1019']
dir_names=['train_data']
