...
LastEditTime: 2020-08-25 21:21:52
...
for dir_name in dir_names:
    ...
    dir_save=join(root,dir_name+'_resize{}_rgb_nopad'.format(size_new))
    ...
    for dir_0 in dir_0s:
        ...
        for image_name in image_names:
            image=cv2.imread(join(dir_read_0,image_name))[...,::-1]
            h, w, c = image.shape
            if w > h:
