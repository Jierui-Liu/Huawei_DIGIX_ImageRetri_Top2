...
LastEditTime: 2020-08-16 23:42:47
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /PyRetri-master-gai1/pyretri/index/re_ranker/re_ranker_impl/fast_qe_kr.py
'''
# -*- coding: utf-8 -*-
...
class QEKR(ReRankerBase):
    ...
    def __call__(self, query_fea: torch.tensor, gallery_fea: torch.tensor,metric:MetricBase, dis: torch.tensor or None = None,
        ...
        # jerry
        sorted_index = self.qe(query_fea, gallery_fea,metric, dis, kr=self.kr)
