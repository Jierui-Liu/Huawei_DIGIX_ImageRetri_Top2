'''
Author: your name
Date: 2020-08-11 10:40:54
LastEditTime: 2020-08-16 23:25:47
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /PyRetri-master-gai1/pyretri/index/re_ranker/re_ranker_impl/query_expansion.py
'''
# -*- coding: utf-8 -*-
...
class QE(ReRankerBase):
    ...
    def __call__(self, query_fea: torch.tensor, gallery_fea: torch.tensor, metric:MetricBase, dis: torch.tensor or None = None,
        ...
        for i in range(self._hyper_params['qe_times']):
            ...
            # jerry
            dis = metric._cal_dis(query_fea, gallery_fea)
